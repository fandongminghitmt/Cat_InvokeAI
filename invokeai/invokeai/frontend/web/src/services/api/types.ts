...
const _zVideoDTO = z.object({
  ...
  video_url: z.string(),
  thumbnail_url: z.string(),
  video_origin: zResourceOrigin,
  video_category: zImageCategory, // Reusing ImageCategory for now
  width: z.number().int().gt(0),
  height: z.number().int().gt(0),
...
// Audios
const _zAudioDTO = z.object({
  audio_name: z.string(),
  audio_url: z.string(),
  thumbnail_url: z.string().nullish(),
  audio_origin: zResourceOrigin,
  audio_category: zImageCategory, // Reusing ImageCategory for now
  duration: z.number().gt(0),
  created_at: z.string(),
  updated_at: z.string(),
  deleted_at: z.string().nullish(),
