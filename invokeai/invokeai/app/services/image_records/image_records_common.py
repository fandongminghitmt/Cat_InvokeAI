...
class VideoRecord(BaseModelExcludeNull):
    ...
    video_origin: ResourceOrigin = Field(description="The type of the video.")
    video_category: ImageCategory = Field(description="The category of the video.") # Reuse ImageCategory for now
    ...
    fps: float = Field(description="The frame rate of the video.")
    ...
    has_workflow: bool = Field(description="Whether this video has a workflow.")


class AudioRecord(BaseModelExcludeNull):
    """Deserialized audio record without metadata."""

    audio_name: str = Field(description="The unique name of the audio.")
    audio_origin: ResourceOrigin = Field(description="The type of the audio.")
    audio_category: ImageCategory = Field(description="The category of the audio.")
    duration: float = Field(description="The duration of the audio in seconds.")
    created_at: Union[datetime.datetime, str] = Field(description="The created timestamp of the audio.")
    updated_at: Union[datetime.datetime, str] = Field(description="The updated timestamp of the audio.")
    deleted_at: Optional[Union[datetime.datetime, str]] = Field(
        default=None, description="The deleted timestamp of the audio."
    )
    is_intermediate: bool = Field(description="Whether this is an intermediate audio.")
    session_id: Optional[str] = Field(
        default=None,
        description="The session ID that generated this audio, if it is a generated audio.",
    )
    node_id: Optional[str] = Field(
        default=None,
        description="The node ID that generated this audio, if it is a generated audio.",
    )
    starred: bool = Field(description="Whether this audio is starred.")
    has_workflow: bool = Field(description="Whether this audio has a workflow.")


class VideoRecordChanges(ImageRecordChanges):
